    ...
    <div className="flex flex-col items-center mx-auto">
      ...
      <div className="z-10 my-3 px-4 animate-fade-in-resume" style={{'--word-index': '4'}}>
        <div className="bg-white bg-opacity-70 rounded-2xl  p-2 flex flex-col justify-between">
          ...
          <h3 className="text-xl  text-blue-700 font-bold text-center hover:text-green-700">
          <a className=''  href='https://docs.google.com/document/d/1llq1DX6X4X4ZdicFgtOZx8yR6TEdXid3t6eXNyRES-U' download='Resume - Tim Cunningham' >View Resume</a></h3>
